...
(function () {
  var searchData = [
    // { title:'七龍珠', path:'pages/feature-dragon-ball.html', keywords:'龍珠 龍族之血 神龍之羽 神龍錢包 缺角的羽毛 強化 1星 2星 3星 4星 5星 6星 7星 飛龍 dragon ball' },
    ...
    { title:'高技獲取途徑', path:'pages/feature-high-skill.html', keywords:'高技 高技碎片箱 自選 取得 途徑 烈焰之魂 碎裂的烈焰之魂 大地屏障 精準射擊 反擊屏障 破壞盔甲 流星雨 究極光裂術 究極光裂 神奇扭蛋 BOSS 掉落 技能 high skill' },
    ...
    { title:'活動資訊', path:'pages/events.html', keywords:'活動 LINE 禮包 新手 BOSS挑戰 八八節 父親節 亞丁之父 赫卡特禮包' },
    ...
    { title:'八八節感恩回饋', path:'pages/event-fathers-day.html', keywords:'八八節 父親節 祝福強化卷軸 8888 贊助 限時' },
    { title:'亞丁之父叛變', path:'pages/event-aden-father.html', keywords:'亞丁之父 叛變 BOSS 亞丁黃冠 技能書 衝擊之暈 聖結界 三重矢 雙重破壞 防爆卷軸 製作秘笈 武器箱 防具箱 飾品箱' },
    { title:'赫卡特強化禮包', path:'pages/event-hecate-pack.html', keywords:'赫卡特 禮包 499 夜月之力 祝福卷軸 防爆卷箱 強化' },
